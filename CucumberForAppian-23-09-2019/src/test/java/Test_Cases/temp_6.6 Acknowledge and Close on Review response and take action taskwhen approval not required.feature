@6.6_AcknowledgeAndCloseonReviewResponseAndTakeActionTaskwhenApprovalNotRequired
Feature: Acknowledge and Close the Review Response from Accounting team when approval not required
...
Scenario: Acknowledge and Close the Review Response from Accounting team when approval not required
...
Given I verify grid "[1]" column "[3]" row "[1]" contains "Test"
 ...
 Given I sort grid "[1]" by column "Received On"
    ...
    Given I sort grid "[1]" by column "Received On"
    Given I wait for "4" seconds
Given I verify grid "[1]" column "[1]" row "[2]" contains "Review Response from Accounting Team"
Given I wait for "4" seconds
