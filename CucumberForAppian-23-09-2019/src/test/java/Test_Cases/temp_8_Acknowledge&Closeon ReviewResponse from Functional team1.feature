@8_AcknowledgeAndCloseonReviewResponseFromFunctionalTeamTask
Feature: Acknowledge and close the Review Response from Functional Team Task 
...
Scenario: Acknowledge and close the Review Response from Functional Team Task 
    # Clear the filter set
Given I open "https://harbourvesttest.appiancloud.com/suite/sites/client-service"
Given I wait for "8" seconds 
Given I clear field "Select Filter Set(s)"

#Click on the Review response from Functional Team task
Given I wait for "8" seconds
...
Given I verify grid "[2]" column "[3]" row "[1]" contains "Test"
 ...
 Given I verify grid "[2]" column "[6]" row "[1]" contains "10/01/2019"
 Given I wait for "3" seconds
...
Given I clear field "Select Filter Set(s)"
Given I wait for "5" seconds
Given I populate field "Search" with "8770"
Given I wait for "5" seconds
...
Given I verify grid "[1]" column "[3]" row "[1]" contains "Test"
 Given I wait for "3" seconds
 Given I verify grid "[1]" column "[6]" row "[1]" contains "10/01/2019"
 Given I wait for "3" seconds
