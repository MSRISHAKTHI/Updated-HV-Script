...
Given I wait for "10" seconds
   ...
   Given I wait for "5" seconds
    ...
    Then I click on link "Fulfillment Details"
	  Then I wait for "10" seconds
	   ...
	   #Check the added teams updated in Request Fulfillment Details grid and Verify the details
    ...
    # I check the sorting of Request Fulfillment grid
  ...
  Given I verify grid "[2]" column "[4]" row "[1]" contains "GCS Compliance"
   Given I wait for "4" seconds
  Given I verify grid "[2]" column "[1]" row "[2]" contains "Assign Task Owner"
  Given I wait for "3" seconds
