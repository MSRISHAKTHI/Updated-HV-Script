@5.1ApproveResponse-SendBack
Feature: Send back the Approve Response from Accounting Manager
...
Scenario: Send back the Approve Response from Accounting Manager
...
Given I wait for "5" seconds  
  ...
  Given I wait for "3" seconds
  Given I verify grid "[1]" column "[4]" row "[1]" contains "GCS Accounting"
  Given I wait for "5" seconds
...
Given I verify grid "[1]" column "[3]" row "[1]" contains "Test"
 ...
 Given I wait for "5" seconds
 Given I verify grid "[2]" column "[1]" row "[2]" contains "Approve"
 Given I click on link "Close[1]"
 Given I wait for "5" seconds
 Given I click on link "Close"
 Given I wait for "6" seconds 
