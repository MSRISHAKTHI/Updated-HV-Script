@3.1aAcknowledgeAndCloseonReviewCommentsfromAccTeam
Feature: Acknowledge and Close the Review Comments frommaccounting Team
...
#Click on the Review coments from Accounting Team task
Given I wait for "8" seconds
...
Given I sort grid "[1]" by column "Received On"
Given I wait for "4" seconds
Given I verify grid "[1]" column "[1]" row "[2]" contains "Review Comments from Accounting Team"
Given I wait for "4" seconds
