@1.3a_Request_Initiation-RespondtoClient_FunctionalTeamAccounting
...
Given I verify grid "[1]" column "[10]" row "[1]" contains "$$$Status2$$$" 
 ...
 Given I wait for "5" seconds
 Given I verify grid "[2]" column "[9]" row "[1]" contains "$$$FStatus2$$$" 
 And I wait for "5" seconds
...
Given I sort grid "[1]" by column "Received On"
Given I wait for "4" seconds
Given I verify grid "[1]" column "[1]" row "[3]" contains "$$$InitiateRequest$$$"
Given I wait for "4" seconds
