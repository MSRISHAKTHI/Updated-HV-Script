@6.3SendBackToAccMgrFromReviewResponseAndTakeActionTask
Feature: Send back to function team on Review Response from accounting team task
...
Scenario: Send back to function team on Review Response from accounting team task
...
#Send back to function team on Review Response from accounting team task
...
Given I verify grid "[1]" column "[3]" row "[1]" contains "$$$FTComments$$$"
 ...
 Given I wait for "6" seconds
 Given I verify grid "[2]" column "[1]" row "[1]" contains "$$$ApproveResponse$$$"
 Given I wait for "6" seconds
 Given I verify grid "[2]" column "[9]" row "[2]" contains "$$$ResponseComments$$$"
 Given I wait for "6" seconds
  Given I click on link "Close[1]"
 Given I wait for "5" seconds
 Given I click on link "Close"
