...
Given I wait for "5" seconds
 Given I verify grid "[3]" column "[1]" row "[1]" contains "$$$ApproveResponse$$$"
 Given I wait for "5" seconds
 Given I verify grid "[3]" column "[9]" row "[1]" contains "$$$ApproveComments$$$"
 Given I wait for "5" seconds
 Given I verify grid "[3]" column "[9]" row "[2]" contains "$$$RFComments$$$"
 Given I wait for "5" seconds
 Given I click on link "Close[1]"
...
Given I wait for "5" seconds
  ...
  #Navigate to Fulfillment details dashboard and observe 
   ...
   Given I toggle box "Request Fulfillment Details" visibility
   Given I wait for "5" seconds
   Given I verify grid "[1]" column "[11]" row "[1]" contains "$$$FStatus8$$$"
   Given I wait for "5" seconds
 ...
 Given I wait for "4" seconds
 Given I verify grid "[2]" column "[9]" row "[1]" contains "$$$ApproveComments$$$"
 Given I wait for "5" seconds
